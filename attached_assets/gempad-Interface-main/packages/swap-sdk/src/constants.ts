import { Percent } from '@dapp/swap-sdk-core'
...
export const FACTORY_ADDRESS_MAP = {
  ...
  [ChainId.FANTOM_TESTNET]: FACTORY_ADDRESS,
...
export const INIT_CODE_HASH_MAP: Record<ChainId, Hash> = {
  [ChainId.ETHEREUM]: INIT_CODE_HASH_ETH,
  [ChainId.GOERLI]: INIT_CODE_HASH_ETH,
  [ChainId.FANTOM]: INIT_CODE_HASH_ETH,
  [ChainId.FANTOM_TESTNET]: INIT_CODE_HASH_ETH,
...
export const WNATIVE = {
  ...
  [ChainId.FANTOM]: WETH9[ChainId.SCROLL_SEPOLIA],
  [ChainId.FANTOM_TESTNET]: WETH9[ChainId.SCROLL_SEPOLIA],
...
export const NATIVE = {
  ...
  [ChainId.FANTOM]: ETHER,
  [ChainId.FANTOM_TESTNET]: ETHER,
} satisfies Record<
  ChainId,
  {
    name: string
