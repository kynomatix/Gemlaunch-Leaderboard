import { Native, Token, WETH9 } from '@dapp/sdk'
...
describe('#encodeRouteToPath', () => {
  ...
  it('packs them for exact input single hop', () => {
    expect(encodeRouteToPath(route_0_1, false)).toEqual(
      '0x00000000000000000000000000000000000000010009c40000000000000000000000000000000000000002'
    )
  })

  it('packs them correctly for exact output single hop', () => {
    expect(encodeRouteToPath(route_0_1, true)).toEqual(
      '0x00000000000000000000000000000000000000020009c40000000000000000000000000000000000000001'
    )
  })

  it('packs them correctly for multihop exact input', () => {
    expect(encodeRouteToPath(route_0_1_2, false)).toEqual(
      '0x00000000000000000000000000000000000000010009c400000000000000000000000000000000000000020001f40000000000000000000000000000000000000003'
    )
  })

  it('packs them correctly for multihop exact output', () => {
    expect(encodeRouteToPath(route_0_1_2, true)).toEqual(
      '0x00000000000000000000000000000000000000030001f400000000000000000000000000000000000000020009c40000000000000000000000000000000000000001'
    )
  })

  it('wraps ether input for exact input single hop', () => {
    expect(encodeRouteToPath(route_weth_0, false)).toEqual(
      '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc20009c40000000000000000000000000000000000000001'
    )
  })
  it('wraps ether input for exact output single hop', () => {
    expect(encodeRouteToPath(route_weth_0, true)).toEqual(
      '0x00000000000000000000000000000000000000010009c4c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'
    )
  })
  it('wraps ether input for exact input multihop', () => {
    expect(encodeRouteToPath(route_weth_0_1, false)).toEqual(
      '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc20009c400000000000000000000000000000000000000010009c40000000000000000000000000000000000000002'
    )
  })
  it('wraps ether input for exact output multihop', () => {
    expect(encodeRouteToPath(route_weth_0_1, true)).toEqual(
      '0x00000000000000000000000000000000000000020009c400000000000000000000000000000000000000010009c4c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'
    )
  })
  ...
  it('wraps ether output for exact input multihop', () => {
    expect(encodeRouteToPath(route_0_1_weth, false)).toEqual(
      '0x00000000000000000000000000000000000000010009c400000000000000000000000000000000000000020009c4c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'
    )
  })
  it('wraps ether output for exact output multihop', () => {
    expect(encodeRouteToPath(route_0_1_weth, true)).toEqual(
      '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc20009c400000000000000000000000000000000000000020009c40000000000000000000000000000000000000001'
    )
  })
})
