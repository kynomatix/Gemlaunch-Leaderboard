...
```bash
$ pnpm add @dapp/multicall @dapp/sdk viem
```
...
import { multicallByGasLimit, MulticallRequestWithGas } from '@dapp/multicall'
...
```typescript
import { ChainId } from '@dapp/sdk'
import { getGasLimitOnChain } from '@dapp/multicall'
