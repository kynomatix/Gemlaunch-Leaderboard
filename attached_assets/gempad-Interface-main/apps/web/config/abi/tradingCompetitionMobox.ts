export const tradingCompetitionMoboxABI = [
    ...
    },
    {
        ...
        inputs: [
            {
                indexed: false,
                internalType: 'enum TradingCompV3.CompetitionStatus',
                name: 'status',
                type: 'uint8',
            },
    ...
    },
    {
        ...
        name: 'currentStatus',
        outputs: [
            { internalType: 'enum TradingCompV3.CompetitionStatus', name: '', type: 'uint8' },
        ],
        stateMutability: 'view',
        type: 'function',
    },
    ...
    {
        inputs: [
            { internalType: 'address', name: '_moboxAvatarCollectionAddress', type: 'address' },
        ],
