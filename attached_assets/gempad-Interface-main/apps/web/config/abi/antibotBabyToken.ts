export const AntibotBabyTokenABI = [
    {
        inputs: [
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint256[3]', name: 'feeSettings', type: 'uint256[3]' },
            { internalType: 'uint256', name: 'minimumTokenBalanceForDividends_', type: 'uint256' },
        ],
        name: 'create',
    ...
    {
        inputs: [{ internalType: 'address', name: 'feeReceivingAddress', type: 'address' }],
        name: 'setFeeTo',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
