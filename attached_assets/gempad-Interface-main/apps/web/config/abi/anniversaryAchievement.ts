export const anniversaryAchievementABI = [
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'uint256', name: 'endBlock', type: 'uint256' }],
        name: 'NewEndBlock',
        type: 'event',
    },
    {
        ...
        name: 'NewNumberPointsAndThreshold',
        type: 'event',
    },
    {
        anonymous: false,
    ...
    },
    {
        ...
        name: 'changeNumberPointsAndThreshold',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    },
