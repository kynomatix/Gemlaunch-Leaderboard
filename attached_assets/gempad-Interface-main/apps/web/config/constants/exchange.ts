import { Percent, Token, WNATIVE } from '@dapp/sdk';
...
export const SUGGESTED_BASES: ChainTokenList = {
    ...
    [ChainId.FANTOM]: [USDC[ChainId.FANTOM], USDT[ChainId.FANTOM], WNATIVE[ChainId.FANTOM]],
    [ChainId.FANTOM_TESTNET]: [
        USDC[ChainId.FANTOM_TESTNET],
        USDT[ChainId.FANTOM_TESTNET],
        WNATIVE[ChainId.FANTOM_TESTNET],
    ],
    ...
    [ChainId.POLYGON_ZKEVM]: [
        polygonZkEvmTokens.weth,
        polygonZkEvmTokens.usdt,
        polygonZkEvmTokens.usdc,
    ],
    [ChainId.POLYGON_ZKEVM_TESTNET]: [
        polygonZkEvmTestnetTokens.weth,
        polygonZkEvmTestnetTokens.usdt,
    ],
...
export const LIMIT_ORDERS_DOCS_URL =
    'https://docs.demspad.finance/products/pancakeswap-exchange/limit-orders';
