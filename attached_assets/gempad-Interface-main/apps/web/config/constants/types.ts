// import type { FarmConfigBaseProps, SerializedFarmConfig } from '@dapp/farms'
import { Currency, CurrencyAmount, Percent, Price, Token, Trade, TradeType } from '@dapp/sdk';
import { ChainId } from '@dapp/chains';
// import { LegacyTradeWithStableSwap as TradeWithStableSwap } from '@dapp/smart-router/legacy-router'
...
//    () <- remove this :   !(trade as Trade<Currency, Currency, TradeType> | TradeWithStableSwap<Currency, Currency, TradeType>)?.route
//   )
// }
