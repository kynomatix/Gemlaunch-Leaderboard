...
import { BigintIsh, Currency } from '@dapp/sdk';
import { OnChainProvider, Pool, SmartRouter } from '@dapp/smart-router/evm';
...
export const useV2CandidatePools = candidatePoolsOnChainHookFactory(
    'V2',
    SmartRouter.getV2PoolsOnChain,
);

export const useStableCandidatePools = candidatePoolsOnChainHookFactory(
    'Stable',
